...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Presets
    const presets = {
        'white-crop-top': "photorealistic full-body photograph of the same woman from the reference photograph, standing in a natural three-quarter pose, wearing a white ribbed crop top and blue jeans, natural slender body proportions, natural neck and shoulders seamlessly connecting to head, anatomically correct arms, hands, waist, hips, legs and feet, natural hair, natural indoor bedroom lighting, DSLR photography",
        'casual-blazer': "photorealistic full-body portrait photograph of the same woman, standing 3/4 pose, wearing an elegant navy blue blazer over a clean silk shirt and tailored dark blue denim jeans, natural neck and shoulders, anatomically correct limbs, soft natural studio lighting, 8k resolution, photoreal",
        'summer-dress': "photorealistic full-body shot of the same woman, standing pose outdoors on a sunlit veranda, wearing a light floral summer sundress, natural slender proportions, natural neck and shoulders, natural sunlight, cinematic bokeh, highly detailed",
        'athletic-wear': "photorealistic full-body fitness portrait of the same woman, standing active pose, wearing modern seamless white workout crop top and black yoga leggings, natural athletic proportions, bright modern gym interior lighting, athletic aesthetic"
    };
